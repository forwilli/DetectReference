...
function ReferenceInput() {
  ...
  const handleFillExample = () => {
    const exampleRefs = [
      "Smith, J. (2020). Title of the article. Journal Name, 10(2), 123-145.",
      "Johnson, M. (2019). Book title. Publisher Name.",
      "Brown, A. & Davis, C. (2021). Research methodology. Science Journal, 15(3), 200-215."
    ]
    setInputText(exampleRefs.join('\n'))
  }
    ...
    <div className="space-y-6 animate-in">
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 px-4 py-3 bg-muted/20 rounded-lg border border-border/20">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">{t('input.pasteYourReferences')}</p>
              <p className="text-xs text-muted-foreground">{t('input.helperText')}</p>
            </div>
        ...
        <div className="flex justify-center">
          {!isVerifying ? (
            ...
            >
              ...
              {t('buttons.detectHallucinations')}
            </Button>
          ) : (
            <Button
